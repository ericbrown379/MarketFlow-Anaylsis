...
# Define scheam for full message
schema = StructType([
...
# Parse JSON
    ...
    flattened_df = parsed_df.select(
        ...
        to_timestamp(col("timestamp")).alias("ingestion_time"),
        ...
        col("coin.high_24h"),
        col("coin.low_24h"),
        to_timestamp(col("coin.last_updated")).alias("last_updated")
    )

# Define the output path for the parquet files
    output_path = "/Users/ericbrown/dev/MarketFlow-Analysis/dataframes"
    checkpoint_path = "/Users/ericbrown/dev/MarketFlow-Analysis/checkpoints"
